...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "356ec790-f0b5-4bf0-bd25-dd1fe89643a6",
...
const _lazy_RUIBZR = () => import('../routes/api/berita.mjs');
const _lazy_rXR3cO = () => import('../routes/api/galeri.mjs');
const _lazy_uqLT_7 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/berita', handler: _lazy_RUIBZR, lazy: true, middleware: false, method: undefined },
  { route: '/api/galeri', handler: _lazy_rXR3cO, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_uqLT_7, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uqLT_7, lazy: true, middleware: false, method: undefined }
];
...
export { withTrailingSlash as A, withoutTrailingSlash as B, joinRelativeURL as a, useRuntimeConfig as b, getResponseStatusText as c, defineEventHandler as d, getResponseStatus as e, defineRenderHandler as f, getRouteRulesForPath as g, getQuery as h, createError$1 as i, joinHeaders as j, getRouteRules as k, createHooks as l, getContext as m, normalizeCookieHeader as n, createRouter$1 as o, defu as p, hasProtocol as q, joinURL as r, sanitizeStatusCode as s, toRouteMatcher as t, useNitroApp as u, isScriptProtocol as v, withQuery as w, executeAsync as x, hash$1 as y, parseQuery as z };
